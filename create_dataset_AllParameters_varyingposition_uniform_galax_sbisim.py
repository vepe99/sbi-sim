...
def to_inference_parameters(theta, ):
        ...
        theta[0] = theta[0] # Plummer mass is already in Msun
        theta[1] = theta[1]  # NFW Mvir
        theta[2] = theta[2]  # NFW r_s
        theta[3] = theta[3] # MN M
        theta[4] = theta[4] # MN a
        theta[5] = theta[5] # MN b
        theta[6] = theta[6] #x is already in kpc
        theta[7] = theta[7] #y is already in kpc
        theta[8] = theta[8] #z is already in kpc
        theta[9] = theta[9] #vx is already in km/s
        theta[10] = theta[10] #vz is already in km/s
        return theta
...
if __name__ == "__main__":
    path_stored = '/export/data/vgiusepp/galax_data/data_varying_position_uniform_prior/'
    path_to_save = '/export/data/vgiusepp/galax_data/data_varying_position_uniform_prior/sbi_sim/data/sbi-benchmarks/galax_AllParametersPosition_uniformprior/'
 
    # Create everything in one call
    summary = create_dataset(
        path_stored, 
        path_to_save, 
        num_simulations=[10_000, 1_000_000], 
