...
if __name__ == "__main__":
    path_stored = '/export/data/vgiusepp/odisseo_data/data_fix_position_uniform_prior_TSTIT5/'
    path_to_save = '/export/data/vgiusepp/odisseo_data/data_fix_position_uniform_prior_TSTIT5/sbi_sim/data/sbi-benchmarks/odisseo_AllParameters_fixposition_uniformprior_TSIT5/'
