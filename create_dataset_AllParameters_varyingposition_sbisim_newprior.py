...
if __name__ == "__main__":
    path_stored = '/export/data/vgiusepp/odisseo_data/data_varying_position_newprior/'
    path_to_save = '/export/data/vgiusepp/odisseo_data/data_varying_position_newprior/sbi_sim/data/sbi-benchmarks/odisseo_AllParametersPosition_newprior/'
