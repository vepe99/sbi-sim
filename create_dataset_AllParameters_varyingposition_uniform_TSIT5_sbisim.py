...
if __name__ == "__main__":
    path_stored = '/export/data/vgiusepp/odisseo_data/data_varying_position_uniform_prior_TSIT5/'
    path_to_save = '/export/data/vgiusepp/odisseo_data/data_varying_position_uniform_prior_TSIT5/sbi_sim/data/sbi-benchmarks/odisseo_AllParametersPosition_uniformprior_TSIT5/'
