...
training_loss = []
val_loss = []
# n_epoch # 200 #saved in 1
n_epoch = 500 # saved in 2
...
file_path = save_checkpoint('/export/home/vgiusepp/sbi_diff_sim/sbi-sim/flow_matching_personal/CrossAttentionTransformer/', target=best_params, step=2, )
