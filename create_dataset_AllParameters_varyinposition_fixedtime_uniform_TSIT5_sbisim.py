...
def to_inference_parameters(theta, ):
        ...
        # theta = theta.at[:, 7].set(np.log10(theta[:, 7]))
        theta[:7] = np.log10(theta[:7])  # total integration time
        return theta
...
if __name__ == "__main__":
    path_stored = '/export/data/vgiusepp/odisseo_data/data_varying_position_fixed_time_uniform_prior_TSTIT5/'
    path_to_save = '/export/data/vgiusepp/odisseo_data/data_varying_position_fixed_time_uniform_prior_TSTIT5/sbi_sim/data/sbi-benchmarks/data_varying_position_fixed_time_uniform_prior_TSTIT5/'
